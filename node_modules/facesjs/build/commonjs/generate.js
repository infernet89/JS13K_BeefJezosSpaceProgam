...
var _svgsIndex = _interopRequireDefault(require("./svgs-index"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const getID = type => {
  // @ts-ignore
  return _svgsIndex.default[type][Math.floor(Math.random() * _svgsIndex.default[type].length)];
};
...
const generate = (overrides, options) => {
  ...
  (0, _override.default)(face, overrides);
  return face;
};
